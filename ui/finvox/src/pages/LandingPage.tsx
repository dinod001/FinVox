...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="landing-page">
      ...
      {/* Hero Section — outer wrapper spans 100% width with background grid/blobs */}
      ...
      {/* How it Works */}
      <div className="steps-section-wrapper" id="how-it-works">
      ...
      {/* Testimonials */}
      <div className="testimonials-section-wrapper" id="reviews">
      ...
      {/* CTA Section */}
      <div className="cta-banner-wrapper" id="pricing">
